...
VALUES
('player_shield_guard_v1','Player Shield Guard','Symmetric frontal shield guard. Stamina damage applies only on successful block.', 'shield_block',120,0.30,0.30,TRUE,TRUE,TRUE,0,0,1.0,2.0,'{"source":"chat_recovery","frontFacing":"control_rotation_yaw"}'),
('player_perfect_guard_v1','Player Perfect Guard','Short perfect block/parry-capable guard window for future shield skills.', 'perfect_block',130,0.30,0.30,TRUE,TRUE,TRUE,120,90,0.35,2.0,'{"source":"chat_recovery"}'),
('wolf_attack_vs_guard_v1','Wolf Attack Vs Guard','Default creature attack guard interaction. Normal hit damages health; blocked hit pressures stamina/posture.', 'incoming_melee',120,0.30,0.30,TRUE,TRUE,TRUE,0,0,1.0,0.0,'{"source":"chat_recovery"}')
