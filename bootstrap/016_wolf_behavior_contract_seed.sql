...
VALUES (
    ...
    '{"source":"canonical_bootstrap","threat":{"damageThreatPerPoint":1.0,"postureThreatPerPoint":0.8,"proximityThreatPerSec":2.0,"proximityRangeCm":400,"firstAggroBonus":25,"decayPerSec":6.0,"losBreakDecayMultiplier":3.0,"outOfRangeDecayMultiplier":2.0,"switchThresholdRatio":1.25,"switchCooldownMs":1500,"leashDistanceCm":3500},"pack":{"maxMembers":6,"maxCommittedMembers":1,"joinRadiusCm":1600,"surroundSpacingDeg":60,"commitTokenCooldownMs":1000,"focusPolicy":"soft_focus"},"progression":{"experienceValue":100,"weaponExperienceValue":200}}'
)
ON CONFLICT (id) DO UPDATE SET
