...
('basic_attack_3_shield_drive_v1','grounded_skill','Basic attack 3 shield punch with contact carry.',620,260,180,126,203.2,0,'grounded_skill_action','bounded_smooth_correction','grounded_skill_action_reconciliation',FALSE,FALSE,TRUE,TRUE,'movement','carry_contact','[{"t":0,"v":0.2},{"t":0.25,"v":0.75},{"t":0.65,"v":1.0},{"t":1,"v":0.25}]','[]','{"source":"canonical_bootstrap","design_note":"one-and-a-half-cylinder shield punch"}'),
...
('shield_rush_front_contact_v1','grounded_skill','Shield Rush committed long rush with damage beginning close to shield/body contact.',1100,720,260,960,1148,0,'grounded_skill_action','bounded_smooth_correction','grounded_skill_action_reconciliation',FALSE,FALSE,TRUE,TRUE,'movement','multi_target_carry_push','[{"t":0,"v":0.1},{"t":0.2,"v":0.85},{"t":0.75,"v":1.0},{"t":1,"v":0.25}]','[]','{"front_contact_offset_cm":24,"source":"canonical_bootstrap","design_note":"ten-cylinder committed shield rush with close front contact"}'),
...
('low_fast_lunge_v1','leap','Wolf low fast lunge; crosses target without losing air speed unless hard-controlled, then keeps grounded landing inertia.',860,380,240,918,1310,0,'leap','bounded_smooth_correction','leap_reconciliation',TRUE,FALSE,TRUE,TRUE,'movement','airborne_passthrough','[{"t":0,"v":0.35},{"t":0.16,"v":1.0},{"t":0.68,"v":0.92},{"t":1,"v":0.38}]','[{"t":0,"z":0},{"t":0.34,"z":120},{"t":1,"z":0}]','{"post_landing_inertia_multiplier":1.2,"source":"canonical_bootstrap","canonical_id":"low_fast_lunge_v1","airborne_duration_ms":380,"jump_z_velocity":700,"gravity_scale":1,"expected_apex_ms":320,"landing_detection_policy":"server_grounded_handoff","ground_z_policy":"server_position_is_actor_root","capsule_base_offset":0,"allows_air_control":false,"air_control_modifier":0}')
ON CONFLICT (id) DO UPDATE SET
...
('player_shield_bash',110,170,120,2600,0,'contract','none','after_recovery','{"source":"canonical_bootstrap"}'),
('player_shield_rush',160,720,260,5200,0,'contract','none','after_recovery','{"source":"canonical_bootstrap"}'),
('lunge',3600,380,520,4200,0,'contract','none','none','{"windup_movement":"circle_or_chase_setup","source":"canonical_bootstrap"}')
