...
('jump_v1_authoritative_grounded_handoff','leap','Player leap/jump owns airborne movement until grounded handoff.',960,900,60,280,292,0,'leap','bounded_smooth_correction','leap_reconciliation',TRUE,FALSE,TRUE,TRUE,'movement','grounded_handoff','[{"t":0,"v":0.35},{"t":0.35,"v":0.95},{"t":1,"v":0.62}]','[{"t":0,"z":0},{"t":0.46,"z":110},{"t":1,"z":0}]','{"source":"canonical_bootstrap","ability_key":"jump","airborne_duration_ms":900,"vertical_motion_model":"ballistic","jump_z_velocity":480,"gravity_scale":1,"gravity_z_cm_s2":980,"expected_apex_ms":490,"landing_detection_policy":"server_grounded_handoff","ground_z_policy":"server_position_is_actor_root","capsule_base_offset":0,"allows_air_control":true,"air_control_modifier":0.35}'),
...
('low_fast_lunge_v1','leap','Wolf low fast lunge; crosses target without losing air speed unless hard-controlled, then keeps grounded landing inertia.',860,380,240,918,1310,0,'leap','bounded_smooth_correction','leap_reconciliation',TRUE,FALSE,TRUE,TRUE,'movement','airborne_passthrough','[{"t":0,"v":0.35},{"t":0.16,"v":1.0},{"t":0.68,"v":0.92},{"t":1,"v":0.38}]','[{"t":0,"z":0},{"t":0.34,"z":120},{"t":1,"z":0}]','{"post_landing_inertia_multiplier":1.2,"source":"canonical_bootstrap","canonical_id":"low_fast_lunge_v1","airborne_duration_ms":380,"vertical_motion_model":"curve","jump_z_velocity":700,"gravity_scale":1,"gravity_z_cm_s2":980,"expected_apex_ms":320,"landing_detection_policy":"server_grounded_handoff","ground_z_policy":"server_position_is_actor_root","capsule_base_offset":0,"allows_air_control":false,"air_control_modifier":0}')
ON CONFLICT (id) DO UPDATE SET
...
('lunge',3600,380,520,7200,0,'contract','none','none','{"windup_movement":"circle_or_chase_setup","source":"canonical_bootstrap"}')
