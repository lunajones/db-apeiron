...
('wolf_lunge_airborne_v1','leap','Wolf lunge airborne phase; crosses target without losing air speed unless hard-controlled.',980,430,260,620,760,0,'leap','bounded_smooth_correction','leap_reconciliation',TRUE,FALSE,TRUE,TRUE,'movement','airborne_passthrough','[{"t":0,"v":0.4},{"t":0.18,"v":1.0},{"t":0.72,"v":0.85},{"t":1,"v":0.35}]','[{"t":0,"z":0},{"t":0.36,"z":120},{"t":1,"z":0}]','{"post_landing_inertia_multiplier":1.1,"source":"reconstructed","airborne_duration_ms":430,"jump_z_velocity":700,"gravity_scale":1,"expected_apex_ms":350,"landing_detection_policy":"server_grounded_handoff","ground_z_policy":"server_position_is_actor_root","capsule_base_offset":0,"allows_air_control":false,"air_control_modifier":0}')
ON CONFLICT (id) DO UPDATE SET
