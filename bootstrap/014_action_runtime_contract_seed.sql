...
('dodge_v1_full_iframe','dodge','Player dodge owns position and iframe until movement handoff.',320,260,60,260,1297,0,'dodge','bounded_smooth_correction','dodge_reconciliation',FALSE,FALSE,TRUE,TRUE,'movement','iframe','[{"t":0,"v":0.35},{"t":0.35,"v":1.0},{"t":1,"v":0.2}]','[{"t":0,"z":0},{"t":0.4,"z":18},{"t":1,"z":0}]','{"source":"canonical_bootstrap","ability_key":"dodge","speed_semantics":"distance_over_duration_curve_normalized"}'),
