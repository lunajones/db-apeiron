...
('player_fatality_placeholder','Fatality Slot','Placeholder high cooldown weapon finisher slot.', 'sword_shield','fatality',
 0,0,0, 400,500,700,0,45000, 0,0,0,0, 0,3.0,0,1,'enemy',TRUE, 0,'physical',NULL,0,0,1,1, 0,0,0, 1,TRUE,0, NULL,NULL,0, TRUE,TRUE,TRUE,FALSE,FALSE)
