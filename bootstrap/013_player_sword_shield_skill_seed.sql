...
VALUES
('player_basic_attack_1','Opening Shield Jab','Sword-and-shield light combo opener. Short shield jab steps and grows one player cylinder forward.', 'sword_shield','basic_attack',
 0,0,0, 90,140,120,0,0, 0,0,0,0, 0,1.8,0,1,'enemy',FALSE, 8,'physical',NULL,10,0,1,1.2, 0,0,0.35, 1,FALSE,0.84, 'sword_shield_light_combo',1,2000, TRUE,TRUE,TRUE,FALSE,FALSE),
('player_basic_attack_2','Shield Cross Sweep','Left-to-right shield sweep using a temporal 90-degree frontal cone.', 'sword_shield','basic_attack',
 0,0,0, 100,150,120,0,0, 0,0,0,0, 0,1.8,90,2,'enemy',FALSE, 7,'physical',NULL,9,0,1,1.15, 0,0,0.25, 1,FALSE,0.42, 'sword_shield_light_combo',2,2000, TRUE,TRUE,TRUE,FALSE,FALSE),
('player_basic_attack_3','Shield Drive','Short shield drive finisher that carries contact and pushes enemies.', 'sword_shield','basic_attack',
 0,0,0, 180,260,180,0,0, 0,0,0,0, 0,2.2,0,3,'enemy',FALSE, 6,'physical',NULL,18,0,1,1.1, 0,0,2.1, 1,FALSE,1.26, 'sword_shield_light_combo',3,2000, TRUE,TRUE,TRUE,FALSE,FALSE),
