...
WITH desired (
    ...
    VALUES
    ('low_fast_lunge_effect_v1','lunge','leap',2148::DOUBLE PRECISION,2192::DOUBLE PRECISION,980,3600,160,TRUE,FALSE,'{"source":"canonical_bootstrap","thread":"DB","surface":"GetSkillMovementEffect(lunge)","prefer":"movement_action_contract","movement_action_contract_id":"low_fast_lunge_v1","post_landing_inertia_multiplier":0.42,"airborne_duration_ms":820,"airborne_passthrough":true,"vertical_arc":"very_low_long_raking"}'::jsonb),
