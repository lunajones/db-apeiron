...
WITH desired (
    ...
    ('player_shield_rush_effect_v1','player_shield_rush','charge',960::DOUBLE PRECISION,1148::DOUBLE PRECISION,1100,160,260,TRUE,FALSE,'{"source":"canonical_bootstrap","prefer":"movement_action_contract","front_contact_offset_cm":8,"design_note":"matches shield_rush_front_contact_v1"}'::jsonb),
