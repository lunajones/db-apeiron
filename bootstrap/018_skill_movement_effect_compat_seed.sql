...
WITH desired (
    ...
    VALUES
    ('low_fast_lunge_effect_v1','lunge','leap',918::DOUBLE PRECISION,940::DOUBLE PRECISION,980,3600,500,TRUE,FALSE,'{"source":"canonical_bootstrap","thread":"DB","surface":"GetSkillMovementEffect(lunge)","prefer":"movement_action_contract","movement_action_contract_id":"low_fast_lunge_v1","post_landing_inertia_multiplier":1.1,"airborne_passthrough":true}'::jsonb),
    ('player_shield_rush_effect_v1','player_shield_rush','charge',470::DOUBLE PRECISION,620::DOUBLE PRECISION,830,160,240,TRUE,FALSE,'{"source":"canonical_bootstrap","prefer":"movement_action_contract","design_note":"matches shield_rush_front_contact_v1"}'::jsonb),
    ('player_shield_bash_effect_v1','player_shield_bash','dash',130::DOUBLE PRECISION,280::DOUBLE PRECISION,520,120,180,TRUE,FALSE,'{"source":"canonical_bootstrap","prefer":"movement_action_contract","compat_semantics":"short_charge"}'::jsonb)
)
